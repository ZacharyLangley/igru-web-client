...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({testID = 'dashboard-layout', topContent, bottomContent}) => {
    return (
        <Container id={`${testID}:container`} className={'dash-layout-container'} style={{display: 'flex', flexDirection: 'column'}}>
