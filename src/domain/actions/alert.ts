...
export const dispatchMessageAlertAction = (message: string): DispatchMessageAlertAction => ({
...
export const dispatchSuccessAlertAction = (message: string): DispatchSuccessAlertAction => ({
...
export const dispatchFailureAlertAction = (message: string): DispatchFailureAlertAction => ({
...
export const dispatchErrorAlertAction = (message: string): DispatchErrorAlertAction => ({
...
export const dispatchCriticalAlertAction = (message: string): DispatchCriticalAlertAction => ({
...
export const dispatchNoncriticalAlertAction = (message: string): DispatchNoncriticalAlertAction => ({
...
export const dismissSelectedAlertAction = (id: number): DismissSelectedAlertAction => ({
