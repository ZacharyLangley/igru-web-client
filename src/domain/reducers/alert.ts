...
const addAlertItem = (state: AlertState, item: Alert, alertType: AlertTypes) => ({
    ...state,
    alerts: [
        {...item, alertType},
        ...state.alerts
...
export default function alerts(
    ...
    action: DispatchMessageAlertAction
        | DispatchSuccessAlertAction
        | DispatchFailureAlertAction
        | DispatchErrorAlertAction
        | DispatchCriticalAlertAction
    ...
    switch(action.type) {
        ...
        case AlertActionTypes.DISMISS_SELECTED_ALERT:
            ...
            return {
                ...state,
                alerts: state.alerts.filter((alert, index) => index !== action.value.id),
            }
